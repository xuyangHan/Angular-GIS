(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~layers-BaseDynamicLayerView2D-js~layers-FeatureLayerView2D-js~layers-GeoRSSLayerView2D-js~la~d5038d65"],{
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "C_LABEL_STRIDE_SPEC", function() { return j; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "C_LABEL_VERTEX_DEF", function() { return y; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "C_LINE_STRIDE_SPEC", function() { return I; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "C_LINE_VERTEX_DEF", function() { return w; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "C_TEXT_STRIDE_SPEC", function() { return E; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "C_VBO_INFO", function() { return _; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "copyMeshData", function() { return Z; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createGeometryData", function() { return q; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createProgramDescriptor", function() { return re; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createTextureFromTexelData", function() { return D; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "forEachGeometryType", function() { return te; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "geometryToMappedGeometry", function() { return G; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getBytes", function() { return J; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getCapType", function() { return K; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getJoinType", function() { return P; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getNamedBuffers", function() { return z; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getPixelArrayCtor", function() { return Y; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getPixelBytes", function() { return W; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getTransformParams", function() { return X; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getVVType", function() { return S; });
...
See https://js.arcgis.com/4.19/esri/copyright.txt for details.
*/
const u=_core_Logger_js__WEBPACK_IMPORTED_MODULE_1__["default"].getLogger("esri.views.2d.engine.webgl.Utils"),f="geometry",l="per_instance",m="per_instance_vv",d=[{name:f,strideInBytes:32,divisor:0}],p=[{name:f,strideInBytes:32,divisor:0}],h=[{name:f,strideInBytes:12,divisor:0}],w=[{name:f,strideInBytes:36,divisor:0}],v=[{name:f,strideInBytes:32,divisor:0}],y=[{name:f,strideInBytes:36,divisor:0}];function g(e){const r={};for(const t of e)r[t.name]=t.strideInBytes;return r}const b=g(d),L=g(p),A=g(h),I=g(w),E=g(v),j=g(y);function T(e,r){switch(e){case _enums_js__WEBPACK_IMPORTED_MODULE_9__["WGLGeometryType"].MARKER:return b;case _enums_js__WEBPACK_IMPORTED_MODULE_9__["WGLGeometryType"].FILL:return r?A:L;case _enums_js__WEBPACK_IMPORTED_MODULE_9__["WGLGeometryType"].LINE:return I;case _enums_js__WEBPACK_IMPORTED_MODULE_9__["WGLGeometryType"].TEXT:return E;case _enums_js__WEBPACK_IMPORTED_MODULE_9__["WGLGeometryType"].LABEL:return j}}const x=[f],F=[f],M=[f],U=[f],B=[f];function z(e){switch(e){case _enums_js__WEBPACK_IMPORTED_MODULE_9__["WGLGeometryType"].MARKER:return x;case _enums_js__WEBPACK_IMPORTED_MODULE_9__["WGLGeometryType"].FILL:return F;case _enums_js__WEBPACK_IMPORTED_MODULE_9__["WGLGeometryType"].LINE:return M;case _enums_js__WEBPACK_IMPORTED_MODULE_9__["WGLGeometryType"].TEXT:return U;case _enums_js__WEBPACK_IMPORTED_MODULE_9__["WGLGeometryType"].LABEL:return B}}function C(e){switch(e%4){case 0:case 2:return 4;case 1:case 3:return 1}}function R(e,r){switch(r%4){case 0:case 2:return new Uint32Array(Math.floor(e*r/4));case 1:case 3:return new Uint8Array(e*r)}}function O(e,r){switch(r%4){case 0:case 2:return new Uint32Array(e);case 1:case 3:return new Uint8Array(e)}}function $(e){return _SymbolProperties_js__WEBPACK_IMPORTED_MODULE_11__["TextProperties"].pool.acquire(e.color?Object(_color_js__WEBPACK_IMPORTED_MODULE_10__["copyAndPremultiply"])(e.color):[255,255,255,255],e.haloColor?Object(_color_js__WEBPACK_IMPORTED_MODULE_10__["copyAndPremultiply"])(e.haloColor):[255,255,255,255],Object(_core_screenUtils_js__WEBPACK_IMPORTED_MODULE_4__["pt2px"])(e.haloSize),Object(_core_screenUtils_js__WEBPACK_IMPORTED_MODULE_4__["pt2px"])(e.font.size),e.angle*Math.PI/180,e.xoffset/e.font.size,e.yoffset/e.font.size,"left"===e.horizontalAlignment?0:"right"===e.horizontalAlignment?1:.5,"top"===e.verticalAlignment?0:"bottom"===e.verticalAlignment?1:.5)}function N(e){return null!=e}function k(e){return"number"==typeof e}function K(e,t){switch(e){case"butt":return 0;case"round":return t?2:1;case"square":return 2;default:return u.error(new _core_Error_js__WEBPACK_IMPORTED_MODULE_2__["default"]("mapview-invalid-type",`Cap type ${e} is not a valid option. Defaulting to round`)),1}}function P(e){switch(e){case"miter":return 2;case"bevel":return 0;case"round":return 1;default:return u.error(new _core_Error_js__WEBPACK_IMPORTED_MODULE_2__["default"]("mapview-invalid-type",`Join type ${e} is not a valid option. Defaulting to round`)),1}}function S(e){switch(e){case"opacity":return _enums_js__WEBPACK_IMPORTED_MODULE_9__["VVType"].OPACITY;case"color":return _enums_js__WEBPACK_IMPORTED_MODULE_9__["VVType"].COLOR;case"rotation":return _enums_js__WEBPACK_IMPORTED_MODULE_9__["VVType"].ROTATION;case"size":return _enums_js__WEBPACK_IMPORTED_MODULE_9__["VVType"].SIZE;default:return u.error(`Cannot interpret unknown vv: ${e}`),null}}function X(e){const{transform:r,hasZ:t,hasM:n}=e;return{transform:r,hasZ:t,hasM:n}}function Z(e,r,t,n,o,s,i){for(const c in s){const r=s[c].stride,n=C(r),i=s[c].data,a=t[c].data,u=r*o.vertexCount/n,f=r*e/n,l=r*o.vertexFrom/n;for(let e=0;e<u;++e)a[e+f]=i[e+l]}const a=o.indexCount;for(let c=0;c<a;++c)n[c+r]=i[c+o.indexFrom]-o.vertexFrom+e}const _={[f]:35044};function q(e,r){const t=[];for(let n=0;n<5;++n){const o=z(n),s={};for(const e of o)s[e]={data:r(n,e)};t.push({data:e(n),buffers:s})}return t}function D(e,r){let n,s;return Object(_core_mathUtils_js__WEBPACK_IMPORTED_MODULE_3__["isPowerOfTwo"])(r.width)&&Object(_core_mathUtils_js__WEBPACK_IMPORTED_MODULE_3__["isPowerOfTwo"])(r.height)?(n=!0,s=9987):(n=!1,s=9729),new _webgl_Texture_js__WEBPACK_IMPORTED_MODULE_7__["default"](e,{target:3553,pixelFormat:6408,internalFormat:6408,dataType:5121,hasMipmap:n,samplingMode:s,wrapMode:33071,flipped:!0},r)}function G(e){return{vertexFrom:void 0,vertexTo:void 0,geometry:e}}function J(e){switch(e){case 5120:case 5121:return 1;case 5122:case 5123:return 2;case 5126:case 5124:case 5125:return 4}}function W(e){switch(e){case 5121:return 1;case 32819:return 2;case 5126:return 4;default:return void u.error(new _core_Error_js__WEBPACK_IMPORTED_MODULE_2__["default"]("webgl-utils",`Unable to handle type ${e}`))}}function Y(e){switch(e){case 5121:return Uint8Array;case 32819:return Uint16Array;case 5126:return Float32Array;default:return void u.error(new _core_Error_js__WEBPACK_IMPORTED_MODULE_2__["default"]("webgl-utils",`Unable to handle type ${e}`))}}function H(e){const r={};for(const t in e){const n=e[t];let o=0;r[t]=n.map((e=>{const r={...e,normalized:e.normalized||!1,divisor:e.divisor||0,offset:o,stride:0};return o+=e.count*J(e.type),r})),r[t].forEach((e=>e.stride=o))}return r}const Q=e=>{const r={};for(const t in e)for(const n of e[t])r[n.name]=n.location;return r},V=e=>{const r={};for(const t in e){const n=e[t];r[t]=n.length?n[0].stride:0}return r},ee=new Map,re=(e,r)=>{if(!ee.has(e)){const t=H(r),n={strides:V(t),bufferLayouts:t,attributes:Q(r)};ee.set(e,n)}return ee.get(e)};function te(e){e(_enums_js__WEBPACK_IMPORTED_MODULE_9__["WGLGeometryType"].MARKER),e(_enums_js__WEBPACK_IMPORTED_MODULE_9__["WGLGeometryType"].FILL),e(_enums_js__WEBPACK_IMPORTED_MODULE_9__["WGLGeometryType"].LINE),e(_enums_js__WEBPACK_IMPORTED_MODULE_9__["WGLGeometryType"].TEXT),e(_enums_js__WEBPACK_IMPORTED_MODULE_9__["WGLGeometryType"].LABEL)}


/***/ })

}]);
//# sourceMappingURL=default~layers-BaseDynamicLayerView2D-js~layers-FeatureLayerView2D-js~layers-GeoRSSLayerView2D-js~la~d5038d65.js.map