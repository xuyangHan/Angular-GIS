(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~layers-graphics-data-FeatureFilter-js~layers-graphics-sources-geojson-GeoJSONSourceWorker-js~eb08e0e9"],{
...
/* harmony import */ var _centroid_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../centroid.js */ "2X7Z");
...
*/
const w=new _core_jsonMap_js__WEBPACK_IMPORTED_MODULE_1__["JSONMap"]({esriSRUnit_Meter:"meters",esriSRUnit_Kilometer:"kilometers",esriSRUnit_Foot:"feet",esriSRUnit_StatuteMile:"miles",esriSRUnit_NauticalMile:"nautical-miles",esriSRUnit_USNauticalMile:"us-nautical-miles"}),j=Object.freeze({}),U=new _OptimizedGeometry_js__WEBPACK_IMPORTED_MODULE_7__["default"],M=new _OptimizedGeometry_js__WEBPACK_IMPORTED_MODULE_7__["default"],F=new _OptimizedGeometry_js__WEBPACK_IMPORTED_MODULE_7__["default"],G={esriGeometryPoint:_featureConversionUtils_js__WEBPACK_IMPORTED_MODULE_8__["convertToPoint"],esriGeometryPolyline:_featureConversionUtils_js__WEBPACK_IMPORTED_MODULE_8__["convertToPolyline"],esriGeometryPolygon:_featureConversionUtils_js__WEBPACK_IMPORTED_MODULE_8__["convertToPolygon"],esriGeometryMultipoint:_featureConversionUtils_js__WEBPACK_IMPORTED_MODULE_8__["convertToMultipoint"]};function N(e,t,r,i=e.hasZ,o=e.hasM){const n=e.hasZ&&i,s=e.hasM&&o;if(r){const a=Object(_featureConversionUtils_js__WEBPACK_IMPORTED_MODULE_8__["quantizeOptimizedGeometry"])(F,t,e.hasZ,e.hasM,"esriGeometryPoint",r,i,o);return Object(_featureConversionUtils_js__WEBPACK_IMPORTED_MODULE_8__["convertToPoint"])(a,n,s)}return Object(_featureConversionUtils_js__WEBPACK_IMPORTED_MODULE_8__["convertToPoint"])(t,n,s)}function O(e,t,r){return"esriGeometryPolygon"===e.geometryType&&t&&(t.centroid||t.geometry)?(t.centroid||(t.centroid=Object(_centroid_js__WEBPACK_IMPORTED_MODULE_9__["getCentroidOptimizedGeometry"])(new _OptimizedGeometry_js__WEBPACK_IMPORTED_MODULE_7__["default"],t.geometry,e.hasZ,e.hasM)),N(e,t.centroid,r)):null}function _(e,t,r,i,o,n,s=t,a=r){const l=t&&s,m=r&&a,u=i?"coords"in i?i:i.geometry:null;if(!u)return null;if(o){let i=Object(_featureConversionUtils_js__WEBPACK_IMPORTED_MODULE_8__["generalizeOptimizedGeometry"])(M,u,t,r,e,o,s,a);return n&&(i=Object(_featureConversionUtils_js__WEBPACK_IMPORTED_MODULE_8__["quantizeOptimizedGeometry"])(F,i,l,m,e,n)),G[e](i,l,m)}if(n){const i=Object(_featureConversionUtils_js__WEBPACK_IMPORTED_MODULE_8__["quantizeOptimizedGeometry"])(F,u,t,r,e,n,s,a);return G[e](i,l,m)}return Object(_featureConversionUtils_js__WEBPACK_IMPORTED_MODULE_8__["removeZMValues"])(U,u,t,r,s,a),G[e](U,l,m)}async function J(e,t,r){const{outFields:i,orderByFields:o,groupByFieldsForStatistics:n,outStatistics:s}=e;if(i)for(let a=0;a<i.length;a++)i[a]=i[a].trim();if(o)for(let a=0;a<o.length;a++)o[a]=o[a].trim();if(n)for(let a=0;a<n.length;a++)n[a]=n[a].trim();if(s)for(let a=0;a<s.length;a++)s[a].onStatisticField&&(s[a].onStatisticField=s[a].onStatisticField.trim());return e.geometry&&!e.outSR&&(e.outSR=e.geometry.spatialReference),v(e,t,r)}async function P(e,t,r){return v(e,t,r)}async function v(t,r,i){if(!t)return null;let{where:o}=t;if(t.where=o=o&&o.trim(),(!o||/^1 *= *1$/.test(o)||r&&r===o)&&(t.where=null),!t.geometry)return t;let a=await Z(t);if(t.distance=0,t.units=null,"esriSpatialRelEnvelopeIntersects"===t.spatialRel){const{spatialReference:e}=t.geometry;a=Object(_geometry_support_extentUtils_js__WEBPACK_IMPORTED_MODULE_3__["getGeometryExtent"])(a),a.spatialReference=e}t.geometry=a,await Object(_projectionSupport_js__WEBPACK_IMPORTED_MODULE_10__["checkProjectionSupport"])(a.spatialReference,i);const m=(await Object(_geometry_support_normalizeUtils_js__WEBPACK_IMPORTED_MODULE_6__["normalizeCentralMeridian"])(Object(_geometry_support_jsonUtils_js__WEBPACK_IMPORTED_MODULE_4__["fromJSON"])(a)))[0];if(Object(_core_maybe_js__WEBPACK_IMPORTED_MODULE_0__["isNone"])(m))throw j;const c=m.toJSON(),u=await Object(_projectionSupport_js__WEBPACK_IMPORTED_MODULE_10__["project"])(c,c.spatialReference,i);if(!u)throw j;return u.spatialReference=i,t.geometry=u,t}async function Z(e){const{geometry:t,distance:n,units:s}=e;if(null==n||"vertexAttributes"in t)return t;const l=t.spatialReference,m=s?w.fromJSON(s):Object(_core_unitUtils_js__WEBPACK_IMPORTED_MODULE_5__["getUnitString"])(l),c=l&&(Object(_geometry_support_spatialReferenceUtils_js__WEBPACK_IMPORTED_MODULE_2__["isGeographic"])(l)||Object(_geometry_support_spatialReferenceUtils_js__WEBPACK_IMPORTED_MODULE_2__["isWebMercator"])(l))?t:await Object(_projectionSupport_js__WEBPACK_IMPORTED_MODULE_10__["checkProjectionSupport"])(l,_geometry_support_spatialReferenceUtils_js__WEBPACK_IMPORTED_MODULE_2__["WGS84"]).then((()=>Object(_projectionSupport_js__WEBPACK_IMPORTED_MODULE_10__["project"])(t,_geometry_support_spatialReferenceUtils_js__WEBPACK_IMPORTED_MODULE_2__["WGS84"])));return(await b())(c.spatialReference,c,n,m)}async function b(){return(await Promise.all(/*! import() | geometry-geometryEngineJSON-js */[__webpack_require__.e("default~chunks-geometryEngineBase-js~geometry-geometryEngine-js~geometry-geometryEngineJSON-js~geome~1472b8fb"), __webpack_require__.e("common"), __webpack_require__.e("geometry-geometryEngineJSON-js")]).then(__webpack_require__.bind(null, /*! ../../../geometry/geometryEngineJSON.js */ "AKzY"))).geodesicBuffer}function x(e){return e&&z in e?JSON.parse(JSON.stringify(e,B)):e}const z="_geVersion",B=(e,t)=>e!==z?t:void 0;
...
/* harmony import */ var _geometry_support_intersects_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../geometry/support/intersects.js */ "PNY3");
/* harmony import */ var _geometry_support_jsonUtils_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../geometry/support/jsonUtils.js */ "qatw");
/* harmony import */ var _OptimizedGeometry_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../OptimizedGeometry.js */ "gVKr");
...
/* harmony import */ var _contains_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../contains.js */ "Uz7T");
...
See https://js.arcgis.com/4.19/esri/copyright.txt for details.
*/
const c="feature-store:unsupported-query",R={esriSpatialRelIntersects:"intersects",esriSpatialRelContains:"contains",esriSpatialRelCrosses:"crosses",esriSpatialRelDisjoint:"disjoint",esriSpatialRelEnvelopeIntersects:"intersects",esriSpatialRelIndexIntersects:null,esriSpatialRelOverlaps:"overlaps",esriSpatialRelTouches:"touches",esriSpatialRelWithin:"within",esriSpatialRelRelation:null},S={spatialRelationship:{esriSpatialRelIntersects:!0,esriSpatialRelContains:!0,esriSpatialRelWithin:!0,esriSpatialRelCrosses:!0,esriSpatialRelDisjoint:!0,esriSpatialRelTouches:!0,esriSpatialRelOverlaps:!0,esriSpatialRelEnvelopeIntersects:!0,esriSpatialRelIndexIntersects:!1,esriSpatialRelRelation:!1},queryGeometry:{esriGeometryPoint:!0,esriGeometryMultipoint:!0,esriGeometryPolyline:!0,esriGeometryPolygon:!0,esriGeometryEnvelope:!0},layerGeometry:{esriGeometryPoint:!0,esriGeometryMultipoint:!0,esriGeometryPolyline:!0,esriGeometryPolygon:!0,esriGeometryEnvelope:!1}};function G(e){return!0===S.spatialRelationship[e]}function g(e){return!0===S.queryGeometry[Object(_geometry_support_jsonUtils_js__WEBPACK_IMPORTED_MODULE_4__["getJsonType"])(e)]}function j(e){return!0===S.layerGeometry[e]}function h(){return Promise.all(/*! import() | geometry-geometryEngineJSON-js */[__webpack_require__.e("default~chunks-geometryEngineBase-js~geometry-geometryEngine-js~geometry-geometryEngineJSON-js~geome~1472b8fb"), __webpack_require__.e("common"), __webpack_require__.e("geometry-geometryEngineJSON-js")]).then(__webpack_require__.bind(null, /*! ../../../geometry/geometryEngineJSON.js */ "AKzY"))}function v(e,r,l,y,c){if(Object(_geometry_support_jsonUtils_js__WEBPACK_IMPORTED_MODULE_4__["isPolygon"])(r)&&"esriGeometryPoint"===l&&("esriSpatialRelIntersects"===e||"esriSpatialRelContains"===e)){const e=Object(_featureConversionUtils_js__WEBPACK_IMPORTED_MODULE_6__["convertFromPolygon"])(new _OptimizedGeometry_js__WEBPACK_IMPORTED_MODULE_5__["default"],r,!1,!1);return Promise.resolve((r=>Object(_contains_js__WEBPACK_IMPORTED_MODULE_7__["polygonContainsPoint"])(e,!1,!1,r)))}if(Object(_geometry_support_jsonUtils_js__WEBPACK_IMPORTED_MODULE_4__["isPolygon"])(r)&&"esriGeometryMultipoint"===l){const t=Object(_featureConversionUtils_js__WEBPACK_IMPORTED_MODULE_6__["convertFromPolygon"])(new _OptimizedGeometry_js__WEBPACK_IMPORTED_MODULE_5__["default"],r,!1,!1);if("esriSpatialRelContains"===e)return Promise.resolve((e=>Object(_contains_js__WEBPACK_IMPORTED_MODULE_7__["polygonContainsMultipoint"])(t,!1,!1,e,y,c)))}if(Object(_geometry_support_jsonUtils_js__WEBPACK_IMPORTED_MODULE_4__["isExtent"])(r)&&"esriGeometryPoint"===l&&("esriSpatialRelIntersects"===e||"esriSpatialRelContains"===e))return Promise.resolve((e=>Object(_geometry_support_contains_js__WEBPACK_IMPORTED_MODULE_2__["extentContainsPoint"])(r,Object(_utils_js__WEBPACK_IMPORTED_MODULE_9__["getGeometry"])(l,y,c,e))));if(Object(_geometry_support_jsonUtils_js__WEBPACK_IMPORTED_MODULE_4__["isExtent"])(r)&&"esriGeometryMultipoint"===l&&"esriSpatialRelContains"===e)return Promise.resolve((e=>Object(_geometry_support_contains_js__WEBPACK_IMPORTED_MODULE_2__["extentContainsMultipoint"])(r,Object(_utils_js__WEBPACK_IMPORTED_MODULE_9__["getGeometry"])(l,y,c,e))));if(Object(_geometry_support_jsonUtils_js__WEBPACK_IMPORTED_MODULE_4__["isExtent"])(r)&&"esriSpatialRelIntersects"===e){const e=Object(_geometry_support_intersects_js__WEBPACK_IMPORTED_MODULE_3__["getExtentIntersector"])(l);return Promise.resolve((t=>e(r,Object(_utils_js__WEBPACK_IMPORTED_MODULE_9__["getGeometry"])(l,y,c,t))))}return h().then((t=>{const i=t[R[e]].bind(null,r.spatialReference,r);return e=>i(Object(_utils_js__WEBPACK_IMPORTED_MODULE_9__["getGeometry"])(l,y,c,e))}))}async function P(t,i,s){const{spatialRel:o,geometry:n}=t;if(n){if(!G(o))throw new _core_Error_js__WEBPACK_IMPORTED_MODULE_0__["default"](c,"Unsupported query spatial relationship",{query:t});if(Object(_geometry_support_spatialReferenceUtils_js__WEBPACK_IMPORTED_MODULE_1__["isValid"])(n.spatialReference)&&Object(_geometry_support_spatialReferenceUtils_js__WEBPACK_IMPORTED_MODULE_1__["isValid"])(s)){if(!g(n))throw new _core_Error_js__WEBPACK_IMPORTED_MODULE_0__["default"](c,"Unsupported query geometry type",{query:t});if(!j(i))throw new _core_Error_js__WEBPACK_IMPORTED_MODULE_0__["default"](c,"Unsupported layer geometry type",{query:t});if(t.outSR)return Object(_projectionSupport_js__WEBPACK_IMPORTED_MODULE_8__["checkProjectionSupport"])(t.geometry&&t.geometry.spatialReference,t.outSR)}}}function I(e){if(Object(_geometry_support_jsonUtils_js__WEBPACK_IMPORTED_MODULE_4__["isExtent"])(e))return!0;if(Object(_geometry_support_jsonUtils_js__WEBPACK_IMPORTED_MODULE_4__["isPolygon"])(e)){for(const r of e.rings){if(5!==r.length)return!1;if(r[0][0]!==r[1][0]||r[0][0]!==r[4][0]||r[2][0]!==r[3][0]||r[0][1]!==r[3][1]||r[0][1]!==r[4][1]||r[1][1]!==r[2][1])return!1}return!0}return!1}
...
//# sourceMappingURL=default~layers-graphics-data-FeatureFilter-js~layers-graphics-sources-geojson-GeoJSONSourceWorker-js~eb08e0e9.js.map