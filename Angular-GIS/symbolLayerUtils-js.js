...
/* harmony import */ var _core_ItemCache_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../core/ItemCache.js */ "1/KW");
...
*/
let c=m();function m(){return new _core_ItemCache_js__WEBPACK_IMPORTED_MODULE_3__["default"](50)}function a(){c=m()}function y(e,o){if("icon"===e.type)return l(e,o);if("object"===e.type)return b(e,o);throw new _core_Error_js__WEBPACK_IMPORTED_MODULE_1__["default"]("symbol3d:unsupported-symbol-layer","computeLayerSize only works with symbol layers of type Icon and Object")}async function f(e,o){if("icon"===e.type)return p(e,o);if("object"===e.type)return d(e,o);throw new _core_Error_js__WEBPACK_IMPORTED_MODULE_1__["default"]("symbol3d:unsupported-symbol-layer","computeLayerSize only works with symbol layers of type Icon and Object")}async function l(o,t){if(o.resource.href)return h(o.resource.href).then((e=>[e.width,e.height]));if(o.resource.primitive)return Object(_core_maybe_js__WEBPACK_IMPORTED_MODULE_0__["isSome"])(t)?[t,t]:[256,256];throw new _core_Error_js__WEBPACK_IMPORTED_MODULE_1__["default"]("symbol3d:invalid-symbol-layer","symbol layers of type Icon must have either an href or a primitive resource")}function p(e,r){return l(e,r).then((r=>{if(null==e.size)return r;const o=r[0]/r[1];return o>1?[e.size,e.size/o]:[e.size*o,e.size]}))}function h(e){return Object(_request_js__WEBPACK_IMPORTED_MODULE_2__["default"])(e,{responseType:"image"}).then((e=>e.data))}function b(e,r){return w(e,r).then((e=>Object(_geometry_support_aaBoundingBox_js__WEBPACK_IMPORTED_MODULE_4__["size"])(e)))}async function d(e,r){const o=await b(e,r);return Object(_symbolLayerUtils3D_js__WEBPACK_IMPORTED_MODULE_5__["objectSymbolLayerSizeWithResourceSize"])(o,e)}async function w(o,t){if(!o.isPrimitive){const e=o.resource.href,r=c.get(e);if(void 0!==r)return Promise.resolve(r);const t=await Promise.all(/*! import() | views-3d-layers-graphics-objectResourceUtils-js */[__webpack_require__.e("default~layers-BaseDynamicLayerView2D-js~layers-FeatureLayerView2D-js~layers-GeoRSSLayerView2D-js~la~241c29db"), __webpack_require__.e("default~layers-BaseDynamicLayerView2D-js~layers-GeoRSSLayerView2D-js~layers-GraphicsLayerView2D-js~l~c2cf70ea"), __webpack_require__.e("default~views-3d-layers-graphics-objectResourceUtils-js~views-3d-webgl-engine-lib-edgeRendering-Edge~6fe4ca85"), __webpack_require__.e("common"), __webpack_require__.e("views-3d-layers-graphics-objectResourceUtils-js")]).then(__webpack_require__.bind(null, /*! ../../views/3d/layers/graphics/objectResourceUtils.js */ "lKY1")),n=await t.fetch(e,{disableTextures:!0});return c.put(e,n.referenceBoundingBox),n.referenceBoundingBox}let n=null;if(o.resource&&o.resource.primitive&&(n=Object(_geometry_support_aaBoundingBox_js__WEBPACK_IMPORTED_MODULE_4__["create"])(Object(_symbolLayerUtils3D_js__WEBPACK_IMPORTED_MODULE_5__["objectSymbolLayerPrimitiveBoundingBox"])(o.resource.primitive)),Object(_core_maybe_js__WEBPACK_IMPORTED_MODULE_0__["isSome"])(t)))for(let e=0;e<n.length;e++)n[e]*=t;return n?Promise.resolve(n):Promise.reject(new _core_Error_js__WEBPACK_IMPORTED_MODULE_1__["default"]("symbol:invalid-resource","The symbol does not have a valid resource"))}
