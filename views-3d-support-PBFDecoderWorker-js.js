...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _rest_query_operations_pbfQueryUtils_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../rest/query/operations/pbfQueryUtils.js */ "By9p");
/* harmony import */ var _rest_query_operations_pbfDehydratedFeatureSet_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../rest/query/operations/pbfDehydratedFeatureSet.js */ "jVMl");
/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.19/esri/copyright.txt for details.
*/
class t{_parseFeatureQuery(t){const s=Object(_rest_query_operations_pbfQueryUtils_js__WEBPACK_IMPORTED_MODULE_0__["parsePBFFeatureQuery"])(t.buffer,new _rest_query_operations_pbfDehydratedFeatureSet_js__WEBPACK_IMPORTED_MODULE_1__["DehydratedFeatureSetParserContext"](t.options)),o={...s,spatialReference:s.spatialReference.toJSON(),fields:s.fields?s.fields.map((e=>e.toJSON())):void 0};return Promise.resolve(o)}}function s(){return new t}/* harmony default export */ __webpack_exports__["default"] = (s);
...
/*!*************************************************************************!*\
  ...
  \*************************************************************************/
/*! exports provided: equals, DehydratedFeatureClass, DehydratedFeatureSetClass, computeAABB, computeAABR, estimateGeometryObjectSize, estimateSize, expandAABB, expandAABR, fromFeatureSetJSON, fromJSONGeometry, getObjectId, hasGeometry, hasVertices, isDehydratedPoint, isFeatureGeometry, makeDehydratedPoint, numVertices */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "computeAABB", function() { return B; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "computeAABR", function() { return L; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "estimateGeometryObjectSize", function() { return R; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "estimateSize", function() { return w; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "expandAABB", function() { return J; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "expandAABR", function() { return O; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getObjectId", function() { return P; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "hasGeometry", function() { return M; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "hasVertices", function() { return T; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isDehydratedPoint", function() { return v; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "numVertices", function() { return S; });
...
/* harmony import */ var _zscale_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./zscale.js */ "iRQj");
